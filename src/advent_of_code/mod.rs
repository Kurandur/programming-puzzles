...
pub fn run_solution(year: u16, day: u8, part: u8) -> Result<String, std::io::Error> {
    ...
    let result = match (year, day, part) {
        ...
        (2025, 6, 1) => {
            SolutionResult::U64(aoc2025::day06::part_one(aoc2025::day06::generator(input)))
        }
        (2025, 6, 2) => {
            SolutionResult::U64(aoc2025::day06::part_two(aoc2025::day06::generator(input)))
        }
        (2025, 7, 1) => {
            SolutionResult::U32(aoc2025::day07::part_one(aoc2025::day07::generator(input)))
        }
        (2025, 7, 2) => {
            SolutionResult::U64(aoc2025::day07::part_two(aoc2025::day07::generator(input)))
        }
        (2025, 8, 1) => {
            SolutionResult::U32(aoc2025::day08::part_one(aoc2025::day08::generator(input)))
        }
        (2025, 8, 2) => {
            SolutionResult::U64(aoc2025::day08::part_two(aoc2025::day08::generator(input)))
        }
        (2025, 9, 1) => {
            SolutionResult::U64(aoc2025::day09::part_one(aoc2025::day09::generator(input)))
        }
        (2025, 9, 2) => {
            SolutionResult::U64(aoc2025::day09::part_two(aoc2025::day09::generator(input)))
        }
        (2025, 10, 1) => {
            SolutionResult::U32(aoc2025::day10::part_one(&aoc2025::day10::generator(input)))
        }
        (2025, 10, 2) => {
            SolutionResult::U32(aoc2025::day10::part_two(&aoc2025::day10::generator(input)))
        }
        _ => {
